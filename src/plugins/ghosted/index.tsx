...
export const settings = definePluginSettings({
    ...
    exemptedChannels: {
        ...
        description: "Comma-separated list of channel IDs to exempt from ghosting",
        default: "",
        restartNeeded: false
    },
    ignoreBots: {
...
export default definePlugin({
    ...
    authors: [Devs.sadan, { name: "vei", id: 0n }, { name: "justjxke", id: 0n }, { name: "iamme", id: 0n }],
    settings,
